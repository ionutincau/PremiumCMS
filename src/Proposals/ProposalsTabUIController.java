...
import Sessions.AddSessionUIController;
 ...
 */
public class ProposalsTabUIController implements Initializable,Observer{

    private ProposalsController controller;
    @FXML
    private Button proposalDeleteButton;

    @FXML
    private ListView<Proposal> proposalsListView;

    @FXML
    private Button proposalAddButton;

    @FXML
    private Button proposalEditButton;

    public ProposalsTabUIController()
    {
    ...
    private void loadWindow(String name, Proposal proposal)
    {
        try{
            ...
            AddProposalUIController editController = loader.<AddProposalUIController>getController();
